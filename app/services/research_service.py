...
class ResearchService:
    ...
    def __init__(
        ...
        self.logger = logging.getLogger("app.services.research")
    ...
    def run(
        ...
        *,
        ...
        try:
            ...
            self.logger.exception("Document processing failed: %s", exc)
        ...
        try:
            ...
            self.logger.exception("Research workflow failed for task '%s': %s", normalized_task, exc)
